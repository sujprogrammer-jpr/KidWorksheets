  ...
  if (ws.isTuitionSheet || ws.subject === 'tuition') {
    ...
    setApp(`
      <div class="mentor-screen screen">
        <div class="mentor-header no-print">
          <button class="back-btn" onclick="navigate('/mentor/subject/${ws.subject}')" id="btn-back-print">◀</button>
          <div class="mentor-header-title">Print Preview</div>
  ...
  setApp(`
    <div class="mentor-screen screen">
      <div class="mentor-header no-print">
        ...
        <div class="mentor-header-title">Print Preview</div>
        <div style="display:flex;gap:6px;margin-left:auto">
          <button class="btn btn-secondary btn-sm" onclick="toggleAnswerKey()" id="btn-tog-key">👁 Key</button>
          <button class="btn btn-primary btn-sm" onclick="window.print()" id="btn-print">🖨 Print</button>
        </div>
      </div>
